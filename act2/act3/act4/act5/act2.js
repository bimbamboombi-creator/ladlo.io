...
const script = [
  { speaker: null,    text: "bar bar call karne par finaly she picked up the call.", mood: 'bright' },
  { speaker: 'suvam',  text: "heloo", mood: 'dawn', alexAnim: 'bounce' },
  { speaker: 'suvam', text: "hello.. hello", mood: 'dawn' },
  { speaker: 'kashish',  text: "kaya hai? wo sab birthday mana rahe hai..... hello, voice kt ri hai bro..", mood: 'dawn', alexAnim: 'bounce' },
  { speaker: 'suvam', text: "he..lo...sun wo...", mood: 'dawn' },
  { speaker: 'kashish',  text: "cacke apke liye rkh dungi thik hai...", mood: 'dawn', alexAnim: 'bounce' },
  { speaker: 'suvam', text: "i mean....gift..", mood: 'dawn' },
  { speaker: 'kashish',  text: "gift nahi dekha hai abhi tak.....", mood: 'morning', alexAnim: 'bounce' },
  { speaker: 'suvam', text: ".....beep beep", mood: 'morning' },
  { speaker: 'kashish',  text: "heelo", mood: 'morning' },
  { speaker: null,    text: "car got turnede up side down becuz of high speed....", mood: 'end' },
];
...
function showEnd() {
  ...
  document.getElementById('next-btn').addEventListener('click', () => {
    window.location.href = 'act6/act2.html';   // 👈 change filename here
  });
}
